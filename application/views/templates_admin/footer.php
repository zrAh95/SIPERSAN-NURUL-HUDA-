...
<!-- Bootstrap core JavaScript-->
    ...
    <script>
        const kamarForm = document.querySelector('form');
        const waliSelect = document.querySelector('select[name="id_walikamar"]');

        if (kamarForm && waliSelect) {
            kamarForm.addEventListener('submit', function(e) {
                if (waliSelect.value === '') {
                    e.preventDefault();
    ...
    <script>
            const inputNoKartu = document.getElementById('no_kartu');
            let sedangTap = false;

            // Jalankan hanya pada halaman yang memang punya input RFID.
            if (inputNoKartu) {
                inputNoKartu.addEventListener('click', function() {
                if (!sedangTap) {
